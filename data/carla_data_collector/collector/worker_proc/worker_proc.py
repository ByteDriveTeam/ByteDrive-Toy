...
模块: collector/worker_proc/worker_proc.py
依赖: os, subprocess, common.protocol, common.protocol.checks.protocol_checks, collector.worker_proc.checks.worker_proc_checks
...
from common.protocol.checks.protocol_checks import check_response
from collector.worker_proc.checks.worker_proc_checks import check_python_exe

_MODULE_ROOT = Path(__file__).resolve().parents[2]  # data/carla_data_collector
