...
模块: vis/data_vis/geometry/geometry.py
依赖: numpy, vis.data_vis.geometry.checks.geometry_checks
...
from vis.data_vis.geometry.checks.geometry_checks import check_pose6, check_points
