...
模块: vis/pred_vis/render.py
依赖: cv2, numpy, vis.data_vis.palette.tag_to_bgr, vis.pred_vis.render_checks
...
from vis.pred_vis.render_checks import check_grid_rows
