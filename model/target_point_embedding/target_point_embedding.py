...
依赖: torch, config.schema.TargetPointEmbeddingCfg, model.target_point_embedding.checks.target_point_embedding_checks
读取配置:
...
from model.target_point_embedding.checks.target_point_embedding_checks import check_embedded_features, check_target_points
