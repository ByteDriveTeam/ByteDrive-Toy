...
模块: model/residual_block.py
依赖: torch, model.residual_block_checks
...
说明: RMSNorm 只做均方根归一化不做中心化；残差块为 1x1→3x3→GELU→1x1 瓶颈结构 + 残差；
...
from model.residual_block_checks import (
